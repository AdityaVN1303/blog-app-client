...
const DropDown = ({logout , image}) => {
  ...
  return (
    <div className='rounded-full relative'>
        <img src={image ? `http://localhost:8000/${image}` : 'https://cdn-icons-png.flaticon.com/512/149/149071.png'} alt="user-img" className='w-12 h-12 object-cover rounded-full cursor-pointer' onClick={()=>{setDrop(!drop)}} />
