    ...
    <div className="dashboard max-w-5xl mx-auto my-10 px-5">
        {
            ...
            <img src={user?.image ?  user?.image : "https://cdn-icons-png.flaticon.com/512/149/149071.png"} alt="user-img" className='w-20 h-20 object-cover rounded-full' />
            ...
            <h1 className='font-bold text-3xl mb-10'>My Blogs</h1>
            {
                postList.length > 0 ? postList.map((item)=>{
                    ...
                    <div className="post-info flex items-center space-x-3">
                        <img src={item?.cover} className='w-10 h-10 rounded-full object-cover' alt="post-img" />
